...
window.MoveToTop = function (id, trIndex) {
...
window.closeFixedPostion = function (element) {
    $(".header-mobile").css({
        "display": "flex",
        "visibility": "visible"
    });
...
window.closeLeadFixedPostion = function () {
...
window.collapseExtendFilter = function () {
...
window.SetCookie = function (c_name, c_value, ex_days) {
    var d = new Date();
...
window.setMapLocation = function (latCoord, longCoord) {
...
window.showSortMenu = function (id, e) {
